...
const platformInfo = {
  name: "OpenCart", // Change to Magento, Amazon, etc.
  tagline: "Lightweight & Powerful",
  description: "Building efficient and customized OpenCart solutions for businesses that value speed and simplicity.",
  stats: [
