...
const platformInfo = {
  name: "Amazon", // Change to Magento, Amazon, etc.
  tagline: "Marketplace Dominance",
  description: "From A+ content to full FBA management, we maximize your visibility on the world's largest marketplace.",
  stats: [
    ...
    <main className="min-h-screen bg-white pt-24">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">Why Infynex for {platformInfo.name}?</h2>
