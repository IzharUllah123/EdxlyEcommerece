...
const platformInfo = {
  name: "shift4shop", // Change to Magento, Amazon, etc.
  tagline: "Certified Shopify Experts",
  description: "We build high-converting storefronts on the world's most reliable commerce platform. From custom Liquid themes to headless architecture, we scale your sales.",
  stats: [
