...
const platformInfo = {
  name: "Magento", // Change to Magento, Amazon, etc.
  tagline: "Adobe Commerce Experts",
  description: "Scaling enterprise-level B2B and B2C stores with the robust power of Magento's flexible architecture.",
  stats: [
